# Contributing to background-process

First and foremost, thank you! We appreciate that you want to contribute to background-process, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for background-process**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for background-process:

- star the [project](https://github.com/doowb/background-process)
- tweet your support for background-process
...
- **version**: please note the version of background-process are you using
...
[so]: http://stackoverflow.com/questions/tagged/background-process